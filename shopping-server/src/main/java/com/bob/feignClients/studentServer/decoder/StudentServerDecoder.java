 ...
 **/
@Slf4j
public class StudentServerDecoder implements Decoder {
    ...
    public Object decode(Response response, Type type) {
        ...
        log.info("----------Course decoded: {}", body);

        // 返回对应结果（业务逻辑错误返回false）
        JsonResult jsonResult = GsonUtils.json2Object(body, JsonResult.class);
        return GsonUtils.json2Object(GsonUtils.object2Json(jsonResult.getData()), type);
    }
}
